...
<div class="table-responsive" style="padding: 10px;" id="pivotTable">
  <div class="row">
    <div class="col-md-3 col-sm-3 col-xs-3">
        <div class="form-group">
          ...
          <select style="width: 100%;" class="select2" multiple="True" id="pivot_field" name="pivot_field">
            ...
            <option value="count|Banyaknya" selected>Banyaknya</option>
          </select>
        </div>
    </div>
    <div class="col-md-3 col-sm-3 col-xs-3">
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
  ...
  function get_pivot()
  {
    ...
    $.ajax({
      url : "<?= base_url('harga_konsumsi/ajax_pivot_get')?>",
      type: "POST",
      data: formData,
      dataType: "json",
