...
<div class="table-responsive" style="padding: 10px;" id="tab_pivot">
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu">
             <li><a onclick="pdf_export('pivot_harga_omset', 'Pivot <?= $title ?>')">Download PDF pv</a></li> 
   ...
   <figure class="highcharts-figure">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12" id="panel_pivot">
          <table id="pivot_harga_omset" class="table table-bordered" width="100%">
            <thead>
            </thead>
            <tbody>                   
            </tbody>
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
  ...
  function get_pivot()
  {
    ...
    var pivotTbl = document.getElementById('pivot_harga_omset');

    // alert ("5");

    $.ajax({
      url : "<?= base_url('omset/ajax_pivot_get')?>",
      type: "POST",
      data: formData,
      dataType: "json",
